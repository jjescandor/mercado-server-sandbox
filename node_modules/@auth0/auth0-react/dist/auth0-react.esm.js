...
var Auth0Provider = function (opts) {
        ...
        (function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                        if (!(hasAuthParams() && !skipRedirectCallback)) return [3 /*break*/, 2];
                        return [4 /*yield*/, client.handleRedirectCallback()];
                    case 1:
                        appState = (_a.sent()).appState;
                        onRedirectCallback(appState);
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, client.checkSession()];
                    case 3:
                        _a.sent();
                        _a.label = 4;
    ...
    var buildAuthorizeUrl = useCallback(function (opts) {
        return client.buildAuthorizeUrl(toAuth0LoginRedirectOptions(opts));
    }, [client]);
    var buildLogoutUrl = useCallback(function (opts) { return client.buildLogoutUrl(opts); }, [client]);
    ...
    var getIdTokenClaims = useCallback(function (opts) { return client.getIdTokenClaims(opts); }, [client]);
    ...
    return (React.createElement(Auth0Context.Provider, { value: contextValue }, children));
};
...
var withAuth0 = function (Component) {
    return function WithAuth(props) {
        return (React.createElement(Auth0Context.Consumer, null, function (auth) { return (React.createElement(Component, __assign({}, props, { auth0: auth }))); }));
    };
};
...
var withAuthenticationRequired = function (Component, options) {
    ...
    return function WithAuthenticationRequired(props) {
        ...
        return routeIsAuthenticated ? React.createElement(Component, __assign({}, props)) : onRedirecting();
    };
};

export { Auth0Context, Auth0Provider, Va as InMemoryCache, Xa as LocalStorageCache, OAuthError, pc as User, useAuth0, withAuth0, withAuthenticationRequired };
